...
public struct VinylCreateWithoutAuthoredInput: InputObject {
  ...
  public init(
    ...
    playedBy: GraphQLNullable<PlayedByCreateNestedManyWithoutVinylInput> = nil,
  ...
  public var playedBy: GraphQLNullable<PlayedByCreateNestedManyWithoutVinylInput> {
    get { __data["playedBy"] }
