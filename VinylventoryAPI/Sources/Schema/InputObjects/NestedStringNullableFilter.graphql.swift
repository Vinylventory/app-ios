...
public struct NestedStringNullableFilter: InputObject {
  ...
  public init(
    ...
    not: GraphQLNullable<NestedStringNullableFilter> = nil,
  ...
  public var not: GraphQLNullable<NestedStringNullableFilter> {
    get { __data["not"] }
